...
public class ResolvedPostCacheAdapter implements ResolvedPostCachePort {
    ...
    private static final String KEY_PREPIX = "resolved_post:v1:";
    private static final Long EXPIRE_SECONDS = 60L * 60L * 24L * 7L; // 일주일
    ...
    public void set(ResolvedPost resolvedPost) {
        ...
        redisTemplate.opsForValue().set(this.generateCacheKey(resolvedPost.getId()), jsonString, Duration.ofSeconds(EXPIRE_SECONDS));
    }
